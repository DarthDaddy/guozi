...
public interface ModelDataManager extends DataManager<ModelEntity> {
	...
	String queryReferGroupNameList(String referGroupId);

	List<String> querySysUserId(String modelId);

	List<LinkedHashMap<String, Object>> queryUsername(String[] sysUserId);

	List<String> querySysUserIdPostCode(Object[] usernameArray);
