...
public class MybatisModelDataManager extends AbstractDataManager<ModelEntity> implements ModelDataManager {
	...
	@Override
	public String queryReferGroupNameList(String referGroupId) {
		return (String) getDbSqlSession().selectOne("queryReferGroupNameList", referGroupId);
	}

	@Override
	@SuppressWarnings("unchecked")
	public List<String> querySysUserId(String modelId) {
		return getDbSqlSession().selectList("querySysUserId", modelId);
	}

	@Override
	@SuppressWarnings("unchecked")
	public List<LinkedHashMap<String, Object>> queryUsername(String[] sysUserId) {
		return getDbSqlSession().selectList("queryUsername", sysUserId);
	}

	@Override
	@SuppressWarnings("unchecked")
	public List<String> querySysUserIdPostCode(Object[] usernameArray) {
		return getDbSqlSession().selectList("querySysUserIdPostCode", usernameArray);
	}
